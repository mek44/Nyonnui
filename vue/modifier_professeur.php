	...
	<body>
		...
		<div class="container">
			<div class="row" style="margin-top: 20px;">
				<h1 class="col-lg-12" style="text-align: center;">Edition d'un personnel</h1>
				<form method="post" enctype="multipart/form-data" class="well form-horizontal col-lg-12 col-xs-12 col-sm-12" id="form-inscription">
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group has-feedback">
								<label for="recherche" class="col-lg-3 col-xs-2 col-sm-4 control-label">Recherche:</label>
								<div class="col-lg-4 col-xs-7 col-sm-8">
									<input type="text" class="form-control" id="recherche" name="recherche" />
									<span class="glyphicon form-control-feedback"></span>
								</div>
								<span class="help-block col-lg-8 col-xs-10 col-lg-offset-3 col-xs-offset-1 col-sm-8 col-sm-offset-2">Entrez le numéro de matricule du personnel</span>
							</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h1 class="modal-title" id="titre-alert"><?php echo $observation; ?> Edition personnel</h1>
								</div>
								<div class="modal-body">
									<p id="texte-alert">
									<?php 
										if(isset($_COOKIE['modifier_professeur']))
										{
											echo $_COOKIE['modifier_professeur']; 
										}
										else
										{
		...
		<script src="js/modifier_professeur.js"></script>
	</body>
</html>