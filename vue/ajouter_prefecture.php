	...
	<body>
		...
		<div class="container">
			<div class="row" style="margin-top: 20px;">
				<h1 class="col-lg-12" style="text-align: center;">Nouvelle commune</h1>
				<form method="post" class="well form-horizontal col-lg-6 col-lg-offset-3 col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1" id="form-prefecture">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h1 class="modal-title" id="titre-alert"><?php echo $observation; ?> Nouvelle commune</h1>
								</div>
								<div class="modal-body">
									<p id="texte-alert">
									<?php 
										if(isset($_COOKIE['nouvelle_prefecture']))
										{
											echo $_COOKIE['nouvelle_prefecture']; 
										}
										else
										{
		...
		<script src="js/ajouter_prefecture.js"></script>
	</body>
</html>