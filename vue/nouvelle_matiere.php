	...
	<body>
		...
		<div class="container">
			<div class="row" style="margin-top: 20px;">
				<h1 class="col-lg-12" style="text-align: center;">Nouvelle matière</h1>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h1 class="modal-title" id="titre-alert"><?php echo $observation; ?> Nouvelle matière</h1>
								</div>
								<div class="modal-body">
									<p id="texte-alert">
									<?php 
										if(isset($_COOKIE['nouvelle_matiere']))
										{
											echo $_COOKIE['nouvelle_matiere']; 
										}
										else
										{
		...
		<script src="js/nouvelle_matiere.js"></script>
	</body>
</html>