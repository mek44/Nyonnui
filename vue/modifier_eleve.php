	...
	<body>
		...
		<div class="container">
			<div class="row" style="margin-top: 20px;">
				<h1 class="col-lg-12" style="text-align: center;">Edition élève</h1>
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group has-feedback">
								...
								<span class="help-block col-lg-8 col-xs-10 col-lg-offset-3 col-xs-offset-1 col-sm-8 col-sm-offset-2">Entrez le numéro de matricule de l'élève</span>
							</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h1 class="modal-title" id="titre-alert"><?php echo $observation; ?> Edition élève</h1>
								</div>
								<div class="modal-body">
									<p id="texte-alert">
									<?php 
										if(isset($_COOKIE['modifier_eleve']))
										{
											echo $_COOKIE['modifier_eleve']; 
										}
										else
										{
		...
		<script src="js/modifier_eleve.js"></script>
	</body>
</html>