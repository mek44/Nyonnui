  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">CJSFB</a>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h4>Le Club des Jeunes Scientifiques Francophones du Bénin (CJSFB) recrute : </h4>
            <ul>
                <li>des stagiaires commerciaux sur tout le territoire Béninois pour la promotion de l'application NYONNUI</li> 
                <li>et deux Développeurs Web, rompus à Symfony ou Laravel</li>
            </ul>
            <a class="pull-right" href="http://cjsfb.online/index.php/2018/10/30/recrutement-de-stagiaires-commerciaux-operateurs-trices-de-saisie-developpeurs-web/" target="_blank">Lire l'article</a>
...
<!--Testimonial-->
  ...
  <<script type="text/javascript">
      ...
      if(status==='failed'){
        $("#loginMsg").html("Erreur de connexion. Veuillez vérifier votre login et mot de passe");
